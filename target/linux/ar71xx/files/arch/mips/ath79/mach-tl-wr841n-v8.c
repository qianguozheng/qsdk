...
#define TL_WR841NV8_GPIO_LED_LAN1	20
#define TL_WR841NV8_GPIO_LED_LAN2	21
#define TL_WR841NV8_GPIO_LED_LAN3	22
#define TL_WR841NV8_GPIO_LED_LAN4	19 //weeds change from 12
...
static void __init tl_ap123_setup(int swap_phy4)
{
	...
	//ath79_setup_ar934x_eth_cfg(AR934X_ETH_CFG_SW_ONLY_MODE);//weeds modify at 2014-7-23
	if (swap_phy4)
